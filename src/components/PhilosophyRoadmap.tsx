      ...
      <section className="space-y-8 sm:space-y-12">
        ...
        <div className="space-y-10 sm:space-y-16">
          {FIELD_NOTES.map((note) => (
            <article key={note.id} className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-12 items-start border-b border-white/10 pb-8 sm:pb-12">
              <div className="lg:col-span-4 space-y-1 font-mono-tech flex flex-wrap items-center gap-2 lg:block">
                <span className="text-rose-500 font-bold text-xs">{note.noteNumber}</span>
                <span className="text-slate-500 lg:hidden">•</span>
                <span className="text-slate-400 text-xs">{note.date}</span>
                <span className="text-slate-500 lg:hidden">•</span>
                <span className="text-slate-500 text-[11px] uppercase tracking-wider block">{note.category}</span>
              </div>
              ...
              <div className="lg:col-span-8 space-y-3 sm:space-y-4">
                ...
                <div className="p-3.5 sm:p-4 bg-white/[0.02] border-l-2 border-rose-500 text-xs font-mono-tech text-slate-200">
      ...
      */}
      <section className="space-y-8 sm:space-y-10 border-t border-white/10 pt-12 sm:pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 text-sm">
          <div className="p-4 sm:p-6 bg-[#0b0c12] border border-white/10 space-y-2">
            <div className="text-xs font-mono-tech text-rose-400 font-bold">RESEARCH // 01</div>
            <h3 className="text-base sm:text-lg font-bold text-white font-heading">Adaptive Security Operations</h3>
          ...
          <div className="p-4 sm:p-6 bg-[#0b0c12] border border-white/10 space-y-2">
            ...
            <h3 className="text-base sm:text-lg font-bold text-white font-heading">Multi-Agent AI Log Triage</h3>
            <p className="text-slate-300 text-xs leading-relaxed">
          ...
          <div className="p-4 sm:p-6 bg-[#0b0c12] border border-white/10 space-y-2">
            ...
            <h3 className="text-base sm:text-lg font-bold text-white font-heading">Detection Engineering</h3>
            <p className="text-slate-300 text-xs leading-relaxed">
          ...
          <div className="p-4 sm:p-6 bg-[#0b0c12] border border-white/10 space-y-2">
            ...
            <h3 className="text-base sm:text-lg font-bold text-white font-heading">Autonomous Remediation</h3>
            <p className="text-slate-300 text-xs leading-relaxed">
